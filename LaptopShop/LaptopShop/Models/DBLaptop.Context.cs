...
namespace LaptopShop.Models
{
    ...
    public partial class DBLaptopEntities : DbContext
    {
        ...
        public virtual int C_Customers(string accountName, string passWord, string firstName, string lastName, Nullable<bool> sex, string address, string phoneNumber, string email, string dateRegistation, Nullable<System.DateTime> dateActivated, Nullable<bool> decentralization, Nullable<bool> active)
        {
